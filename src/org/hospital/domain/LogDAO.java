...
public class LogDAO {
	...
	public Log findById(java.lang.Long id) {
		log.debug("getting Log instance with id: " + id);
		try {
			Log instance = (Log) getCurrentSession().get("org.hospital.domain.Log", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Log> findByExample(Log instance) {
		...
		try {
			List<Log> results = (List<Log>) getCurrentSession()
					.createCriteria("org.hospital.domain.Log").add(create(instance)).list();
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Log instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from Log as model where model." + propertyName + "= ?";
	...
	public List<Log> findByContent(Object content) {
		return findByProperty(CONTENT, content);
	}

	public List<Log> findByOperate(Object operate) {
