 ...
 * 
 * @see org.hospital.domain.Permission
...
public class PermissionDAO {
	...
	public Permission findById(java.lang.Integer id) {
		...
		try {
			Permission instance = (Permission) getCurrentSession().get(
					"org.hospital.domain.Permission", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Permission> findByExample(Permission instance) {
		...
		try {
			List<Permission> results = (List<Permission>) getCurrentSession()
					.createCriteria("org.hospital.domain.Permission").add(create(instance)).list();
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Permission instance with property: " + propertyName + ", value: "
				+ value);
		try {
