 ...
 * 
 * @see org.hospital.domain.Department
...
public class DepartmentDAO {
	...
	public Department findById(java.lang.Integer id) {
		...
		try {
			Department instance = (Department) getCurrentSession().get(
					"org.hospital.domain.Department", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Department> findByExample(Department instance) {
		...
		try {
			List<Department> results = (List<Department>) getCurrentSession()
					.createCriteria("org.hospital.domain.Department").add(create(instance)).list();
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Department instance with property: " + propertyName + ", value: "
				+ value);
		try {
	...
	public List<Department> findByPhone(Object phone) {
	...
	public Department merge(Department detachedInstance) {
		...
		try {
			Department result = (Department) getCurrentSession().merge(detachedInstance);
