 ...
 * 
 * @see org.hospital.domain.Project
...
public class ProjectDAO {
	...
	public Project findById(java.lang.Long id) {
		...
		try {
			Project instance = (Project) getCurrentSession().get("org.hospital.domain.Project", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Project> findByExample(Project instance) {
		...
		try {
			List<Project> results = (List<Project>) getCurrentSession()
					.createCriteria("org.hospital.domain.Project").add(create(instance)).list();
	...
	public List<Project> findByIntroduction(Object introduction) {
		return findByProperty(INTRODUCTION, introduction);
	}

	public List<Project> findBySuggestNumber(Object suggestNumber) {
		return findByProperty(SUGGEST_NUMBER, suggestNumber);
	}
	...
	public Project merge(Project detachedInstance) {
		...
		try {
			Project result = (Project) getCurrentSession().merge(detachedInstance);
