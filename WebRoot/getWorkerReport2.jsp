...
<body>
	<h1>getWorkerReport</h1>
	<div class="mt-20">
		<table class="">
			<thead>
				<tr class="">
					<th width="200">departmentId</th>
					<th width="200">departmentName</th>
			...
			<tbody>
				<c:forEach items="${requestScope.rowInfos}" var="rowInfos">
					<tr>
						<td><c:out value="${rowInfos.departmentId}"></c:out></td>
						<td><c:out value="${rowInfos.departmentName}"></c:out></td>
